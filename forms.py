...
from .utils import FieldErrorDict, FieldErrorList, FieldErrorMixin
...
class ExtensibleFormOptions:
	...
	def __init__(self, options=None):
		for attr in dir(options):
			assert attr in self.attrs or attr.startswith("__"), (
				f"Unknown attribute '{attr}' specified in " f"form Meta."
			)
	...
	def __init__(
		...
		**kwargs,
		...
		self.field_error_class = (
			field_error_class
			or getattr(self._meta, "field_error_class")
		...
		# TODO: integrate overrides for 'css', 'attrs', and 'localized_fields'
